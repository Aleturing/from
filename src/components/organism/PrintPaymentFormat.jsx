...
const PrintPaymentFormat = forwardRef(({ carrito, facturaId, client, mostrarImpuestos }, ref) => {
  ...
  const totalConImpuestos = totalAmount + iva + (mostrarImpuestos ? igtf + otrosImpuestos : 0);
    ...
    <div className="relativeCSS" ref={ref}>
      ...
      <div className="p-4 text-black text-sm">
        ...
        <div className="flex justify-between mb-4">
          <div>
            <h1 className="text-xl font-bold">Papelera Prever Business C.A.</h1>
        ...
        <div className="mt-6 text-center text-xs">
          <p>
            Documento emitido conforme a la legislación tributaria de la República Bolivariana de Venezuela.
          </p>
